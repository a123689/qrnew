...
import com.dmobileapps.barcodescanner.extension.toStringId
import com.dmobileapps.barcodescanner.extension.unsafeLazy
...
import com.dmobileapps.barcodescanner.feature.tabs.create.barcode.*
import com.dmobileapps.barcodescanner.feature.tabs.create.qr.*
import com.dmobileapps.barcodescanner.model.Barcode
import com.dmobileapps.barcodescanner.model.schema.App
...
class CreateBarcodeActivity : BaseActivity(), AppAdapter.Listener {
    ...
    fun showDialogLoading() {
        if (dialogLoading == null) {
            dialogLoading = MaterialDialog(this).apply {
                cancelable(false)
    ...
    private fun navigateToBarcodeScreen(barcode: Barcode, finish: Boolean) {
        BarcodeActivity.start(this@CreateBarcodeActivity, barcode, true)
        if (finish) {
            finish()
        }
//        var check = false
//        val dialogProcess = ProgressDialog(this,R.style.DialogMyTheme)
...
//        InterstitialAd.load(
//            this,
//            "ca-app-pub-2051755608375377/5585349735",
//            adRequest,
...
//                        mInterstitialAd?.show(this@CreateBarcodeActivity)
//                    }
//
